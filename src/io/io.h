...
void save_event_nb(const std::vector<size_t>& event_nb, const std::vector<size_t>& lift_nb, const std::vector<size_t> rev_nb, const std::vector<double> lambda, const std::string& filename, const std::string& dirpath);
